<template>
  <div class="vue-image-crop-upload" v-show="value">
    <div class="vicp-wrap pt-0 px-0">
      <div
        class="primary d-flex justify-space-between align-center white--text py-2 px-6"
      >
        <span>Subir imagen</span>
        <v-btn icon @click="off"><v-icon>mdi-close</v-icon></v-btn>
      </div>

      <div class="vicp-step1 ma-6" v-show="step == 1">
        <div
        ...
        <div class="vicp-operate">
          <v-btn @click="off" outlined color="primary">
            {{ lang.btn.off }}
          </v-btn>
        </div>
      </div>

      <div class="vicp-step2 mx-6 my-4" v-if="step == 2">
        <div class="vicp-crop">
              ...
              <v-tooltip bottom>
                <template v-slot:activator="{ on, attrs }">
                  <i
                    ...
                    @mouseout="endZoomSub"
                    @mouseup="endZoomSub"
                    class="vicp-icon5 grey"
                  ></i>
                </template>
                <span>Alejar imagen</span>
              </v-tooltip>
              <v-tooltip bottom>
                <template v-slot:activator="{ on, attrs }">
                  <i
                    ...
                    @mouseout="endZoomAdd"
                    @mouseup="endZoomAdd"
                    class="vicp-icon6 grey"
                  ></i>
                </template>
                <span>Acercar imagen</span>
              </v-tooltip>
            </div>
            <div class="d-flex justify-end vicp-rotate" v-if="!noRotate">
              <v-tooltip bottom>
                <template v-slot:activator="{ on, attrs }">
                  <i class="grey" @click="rotateImg" v-bind="attrs" v-on="on">
                    ↻
                  </i>
                </template>
        ...
        <div class="vicp-operate">
          <v-btn @click="setStep(1)" outlined color="primary" class="mr-2">
            {{ lang.btn.back }}
          </v-btn>

          <v-btn @click="prepareUpload" color="secondary">
            {{ lang.btn.save }}
          </v-btn>
        </div>
      </div>

      <div class="vicp-step3 ma-6" v-if="step == 3">
