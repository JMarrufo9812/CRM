<template>
  <div>
    ...
    <BarActivityTypeByStageInformation
      v-if="!isPreview"
      :information="activitiesByStageHorizontalBarsAndTable.informationBar"
...
import BarActivityTypeByStageInformation from '@/components/charts/bars/BarActivityTypeByStageInformation.vue';

export default {
  name: 'BarActivityTypeByStageData',
  mixins: [barsDataMixin],
  components: { BarActivityTypeByStageInformation },
  props: {
    defaultFilter: {
      type: Object,
      default: () => {
  ...
  computed: {
    options() {
      return this.formatOptions(
        this.activitiesByStageHorizontalBarsAndTable.stages,
      );
    },
    optionsCompare() {
      return this.formatOptions(
