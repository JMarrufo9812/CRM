...
<script>
import CardConvertionRatioModal from '@/components/charts/cards/CardConvertionRatioModal.vue';
import CardConvertionRatioData from '@/components/charts/cards/CardConvertionRatioData.vue';
import CardConvertionRatioFilter from '@/components/charts/cards/CardConvertionRatioFilter.vue';
import { cardsPreviewMixin } from '@/mixins/charts/cardsMixin';

export default {
  name: 'CardConvertionRatioPreview',
  components: {
    CardConvertionRatioData,
    CardConvertionRatioModal,
    CardConvertionRatioFilter,
