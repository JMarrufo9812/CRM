<template>
  <v-container style="padding-right: 10em; padding-left: 10em">
    <h1 class="text-center mt-6">Políticas de Privacidad</h1>
    <p class="mt-6">
      ...
      lo hacemos asegurando que sólo se empleará de acuerdo con los términos de
      este documento. Sin embargo esta Política de Privacidad puede cambiar con
    ...
    <h2 class="my-8">Información que es recogida</h2>
    <p>
    ...
    <h2 class="my-8">Uso de la información recogida</h2>
    <p>
    ...
    <p>
      ...
      al tráfico web, y también facilita las futuras fc barcelona noticias
      recurrente. Otra función que tienen las cookies es que con ellas las web
      pueden reconocerte individualmente y por tanto brindarte el mejor servicio
    ...
    <h2 class="my-8">Enlaces a Terceros</h2>
    <p>
    ...
    <h2 class="my-8">Control de su información personal</h2>
    <p>
      ...
      que se le solicite rellenar un formulario, como el de alta de usuario,
